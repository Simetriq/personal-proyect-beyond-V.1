...
export function GMView() {
  const { characters, connectToCampaign } = useCombatStore();
                          ...
                          <DialogContent className="sm:max-w-[425px] bg-gray-950 border-gray-800 text-white">
                            ...
                            <div className="grid gap-4 py-4">
                              <div className="grid grid-cols-4 items-center gap-4">
                                ...
                                <Input type="number" defaultValue={char.hp} className="col-span-3 border-gray-700 bg-gray-900 text-white" />
                              </div>
                              <div className="grid grid-cols-4 items-center gap-4">
                                <label className="text-right text-gray-400">Oro</label>
                                <Input type="number" defaultValue={char.gold} className="col-span-3 border-gray-700 bg-gray-900 text-white" />
                              </div>
                            </div>
